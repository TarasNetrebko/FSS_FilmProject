 ...
 * limitations under the License.
 */
class Rt{operationForChild(e){return Ce(this.path)?new Rt(this.source,ge(),this.snap.getImmediateChild(e)):new Rt(this.source,ve(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Nt.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{operationForChild(e){if(Ce(this.path)){const t=this.children.subtree(new me(e));return t.isEmpty()?null:t.value?new Rt(this.source,ge(),t.value):new Lt(this.source,ge(),t)}return(0,o.assert)(ye(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Lt(this.source,ve(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Nt.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gn(e,t,n,i,r){const s=new pn;let a,l;if(n.type===Nt.OVERWRITE){const c=n;c.source.fromUser?a=vn(e,t,c.path,c.snap,i,r,s):((0,o.assert)(c.source.fromServer,"Unknown source."),l=c.source.tagged||t.serverCache.isFiltered()&&!Ce(c.path),a=_n(e,t,c.path,c.snap,i,r,l,s))}else if(n.type===Nt.MERGE){const c=n;c.source.fromUser?a=function(e,t,n,i,r,s,o){let a=t;return i.foreach(((i,l)=>{const c=ke(n,i);bn(t,ye(c))&&(a=vn(e,a,c,l,r,s,o))})),i.foreach(((i,l)=>{const c=ke(n,i);bn(t,ye(c))||(a=vn(e,a,c,l,r,s,o))})),a}(e,t,c.path,c.children,i,r,s):((0,o.assert)(c.source.fromServer,"Unknown source."),l=c.source.tagged||t.serverCache.isFiltered(),a=xn(e,t,c.path,c.children,i,r,l,s))}else if(n.type===Nt.ACK_USER_WRITE){const l=n;a=l.revert?function(e,t,n,i,r,s){let a;if(null!=ln(i,n))return t;{const l=new mn(i,t,r),c=t.eventCache.getNode();let u;if(Ce(n)||".priority"===ye(n)){let n;if(t.serverCache.isFullyInitialized())n=sn(i,Ft(t));else{const e=t.serverCache.getNode();(0,o.assert)(e instanceof ot,"serverChildren would be complete if leaf node"),n=on(i,e)}u=e.filter.updateFullNode(c,n,s)}else{const r=ye(n);let o=un(i,r,t.serverCache);null==o&&t.serverCache.isCompleteForChild(r)&&(o=c.getImmediateChild(r)),u=null!=o?e.filter.updateChild(c,r,o,ve(n),l,s):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(c,r,ot.EMPTY_NODE,ve(n),l,s):c,u.isEmpty()&&t.serverCache.isFullyInitialized()&&(a=sn(i,Ft(t)),a.isLeafNode()&&(u=e.filter.updateFullNode(u,a,s)))}return a=t.serverCache.isFullyInitialized()||null!=ln(i,ge()),Dt(t,u,a,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class _i{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function vi(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||Te(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function bi(e,t,n){vi(e,n),wi(e,(e=>Se(e,t)||Se(t,e)))}function wi(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(xi(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function xi(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();w&&C("event: "+n.toString()),q(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class we{static credential(e,t){return me._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=be.parseLink(t);return _(n,"argument-error"),me._fromEmailAndCode(e,n.code,n.tenantId)}constructor(){this.providerId=we.PROVIDER_ID}}we.PROVIDER_ID="password",we.EMAIL_PASSWORD_SIGN_IN_METHOD="password",we.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Oe(e,t,n=!1){var i;const{auth:r}=e,s="reauthenticate";try{const i=await j(e,Ae(r,s,t,e),n);_(i.idToken,r,"internal-error");const o=U(i.idToken);_(o,r,"internal-error");const{sub:a}=o;return _(e.uid===a,r,"user-mismatch"),Ee._forOperation(e,s,i)}catch(e){throw"auth/user-not-found"===(null===(i=e)||void 0===i?void 0:i.code)&&f(r,"user-mismatch"),e}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function dt(e,t){return t?x(t):(_(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zt=new N(5e3,15e3),Ft={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Wt=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Ut(e){const t=e.config;_(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?T(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,s={apiKey:t.apiKey,appName:e.name,v:r.SDK_VERSION},o=Wt.get(e.config.apiHost);o&&(s.eid=o);const a=e._getFrameworks();return a.length&&(s.fw=a.join(",")),`${n}?${(0,i.querystring)(s).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${(0,i.querystring)(c).slice(1)}`}const $t="webStorageSupport";const Xt=class{async _openPopup(e,t,n,i){var r;b(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return qt(e,Vt(e,t,n,k(),i),Xe())}async _openRedirect(e,t,n,i){var r;return await this._originValidation(e),r=Vt(e,t,n,k(),i),Ke().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(b(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await Mt(e),n=Ke().gapi;return _(n,e,"internal-error"),t.open({where:document.body,url:Ut(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Ft,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const r=m(e,"network-request-failed"),s=Ke().setTimeout((()=>{i(r)}),zt.get());function o(){Ke().clearTimeout(s),n(t)}t.ping(o).then(o,(()=>{i(r)}))}))))}(e),n=new Nt(e);return t.register("authEvent",(t=>{_(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send($t,{type:$t},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&t(!!r),f(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Lt(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return ae()||ee()||oe()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ve,this._completeRedirectFn=It,this._overrideRedirectResult=xt}};var Gt,Kt="@firebase/auth",Yt="0.20.4";
/**
 * @license
 * Copyright 2020 Google LLC
 *
