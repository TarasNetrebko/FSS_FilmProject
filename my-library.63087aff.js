 ...
 * limitations under the License.
 */
async function Oe(e,t,n=!1){var i;const{auth:r}=e,s="reauthenticate";try{const i=await U(e,Le(r,s,t,e),n);v(i.idToken,r,"internal-error");const o=q(i.idToken);v(o,r,"internal-error");const{sub:a}=o;return v(e.uid===a,r,"user-mismatch"),Ee._forOperation(e,s,i)}catch(e){throw"auth/user-not-found"===(null===(i=e)||void 0===i?void 0:i.code)&&f(r,"user-mismatch"),e}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
