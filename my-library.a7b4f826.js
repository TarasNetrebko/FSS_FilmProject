function e(e,t,n,i){Object.defineProperty(e,t,{get:n,set:i,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var n="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i={},r={},s=n.parcelRequired7c6;null==s&&((s=function(e){if(e in i)return i[e].exports;if(e in r){var t=r[e];delete r[e];var n={id:e,exports:{}};return i[e]=n,t.call(n.exports,n,n.exports),n.exports}var s=new Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){r[e]=t},n.parcelRequired7c6=s),s.register("kyEFX",(function(t,n){var i,r;e(t.exports,"register",(function(){return i}),(function(e){return i=e})),e(t.exports,"resolve",(function(){return r}),(function(e){return r=e}));var s={};i=function(e){for(var t=Object.keys(e),n=0;n<t.length;n++)s[t[n]]=e[t[n]]},r=function(e){var t=s[e];if(null==t)throw new Error("Could not resolve bundle with id "+e);return t}})),s.register("exG1f",(function(n,i){e(n.exports,"default",(function(){return x})),s("25RCP");var r=s("ix4Jr");s("fQ3Fn");var o=s("8NPS8");s("amyG6");var a=s("g7L5p"),l=s("9B8F0"),c=s("eWCmQ"),u=s("4ZAOK");const h=(0,r.initializeApp)({apiKey:"AIzaSyB4RYBFTyES81mms8M7OWMBEbyDzsl2aDQ",authDomain:"auth-app-16518.firebaseapp.com",databaseURL:"https://auth-app-16518-default-rtdb.europe-west1.firebasedatabase.app",projectId:"auth-app-16518",storageBucket:"auth-app-16518.appspot.com",messagingSenderId:"735705088230",appId:"1:735705088230:web:5f28a2933df786d005bb27"}),d=(0,o.getDatabase)(h),p=(0,a.n)();let f,m,g,y;const v=document.querySelector("#signInBtn"),_=document.querySelector("#logInBtn"),b=document.querySelector("#logOutBtn"),w=document.querySelector("#displayEmail");function x(e){const{poster_path:n,title:i,genres:r,id:s,original_title:a,overview:c,popularity:h,release_date:p,vote_average:f,vote_count:v}=e.data,_=null===n?t(u):"https://image.tmdb.org/t/p/w500"+n,b=l.create(`<div class="modal">\n      <span class="modal__close">\n      <svg class="modal-button-x" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">\n                <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path>\n                </svg>\n      </span>\n      <img\n        class="modal__img"\n        src="${_}"\n        alt="${a} movie poster"\n        class="modal__img"\n      />\n      <div class="modal__description">\n        <h2 class="modal__title">${a}</h2>\n        <table class="modal__info">\n          <tbody>\n            <tr>\n              <td>Vote / Votes</td>\n              <td><span class="modal__rating">${f}</span> / ${v}</td>\n            </tr>\n            <tr>\n              <td>Popularity</td>\n              <td>${h}</td>\n            </tr>\n            <tr>\n              <td>Original Title</td>\n              <td class="modal__original-title">${a}</td>\n            </tr>\n            <tr>\n              <td>Genre</td>\n              <td class="modal__genre">${r.map((e=>`${e.name}`)).join(", ")}</td>\n            </tr>\n          </tbody>\n        </table>\n        <h3 class="modal__plot-title">About</h3>\n        <p class="modal__plot">${c}</p>\n        <div class="modal__button-wrapper">\n          <button id="watchedBtn" type="button" class="modal__button watched visually-hidden">\n            Add to watched\n          </button>\n          <button id="queueBtn" type="button" class="modal__button queue visually-hidden">\n            Add to queue\n          </button>\n          <button id="removeFromWatchedBtn" type="button" class="modal__button watched visually-hidden">\n            Remove from watched\n          </button>\n          <button id="removeFromQueueBtn" type="button" class="modal__button queue visually-hidden">\n            Remove From queue\n          </button>\n        </div>\n      </div>\n    </div>`,{onShow:e=>{document.querySelector("body").style.overflow="hidden"},onClose:e=>{document.querySelector("body").style.overflow="auto"},closable:!0});b.show();const w=document.querySelector("#watchedBtn"),x=document.querySelector("#queueBtn"),k=document.querySelector("#removeFromWatchedBtn"),C=document.querySelector("#removeFromQueueBtn");function I(e){("Escape"===e.key||e.currentTarget.classList.contains("modal__close"))&&(b.closable,document.querySelector("body").style.overflow="auto",b.close(),document.removeEventListener("keyup",I))}k.addEventListener("click",(function(){(0,o.remove)((0,o.ref)(d,`users/${m}/watchedMovies/${s}`));const e=(0,o.ref)((0,o.getDatabase)());(0,o.get)((0,o.child)(e,`users/${m}/watchedMovies`)).then((e=>{e.exists()?(console.log(e.val()),g=e.val(),windows.location.reload()):console.log("No data available")})).catch((e=>{console.error(e)})),window.location.reload()})),C.addEventListener("click",(function(){(0,o.remove)((0,o.ref)(d,`users/${m}/queueOfMovies/${s}`));const e=(0,o.ref)((0,o.getDatabase)());(0,o.get)((0,o.child)(e,`users/${m}/queueOfMovies`)).then((e=>{e.exists()?(console.log(e.val()),y=e.val(),windows.location.reload()):console.log("No data available")})).catch((e=>{console.error(e)})),window.location.reload()})),w.addEventListener("click",(function(){(0,o.set)((0,o.ref)(d,`users/${m}/watchedMovies/${s}`),JSON.stringify(e.data));const t=(0,o.ref)((0,o.getDatabase)());(0,o.get)((0,o.child)(t,`users/${m}/watchedMovies`)).then((e=>{e.exists()?g=e.val():console.log("No data available")})).catch((e=>{console.error(e)})),window.location.reload()})),x.addEventListener("click",(function(){(0,o.set)((0,o.ref)(d,`users/${m}/queueOfMovies/${s}`),JSON.stringify(e.data));const t=(0,o.ref)((0,o.getDatabase)());(0,o.get)((0,o.child)(t,`users/${m}/queueOfMovies`)).then((e=>{e.exists()?(console.log(e.val()),y=e.val()):console.log("No data available")})).catch((e=>{console.error(e)})),window.location.reload()})),(0,o.get)((0,o.child)((0,o.ref)((0,o.getDatabase)()),`users/${m}/watchedMovies/${s}`)).then((e=>{m&&(e.exists()?(w.classList.remove("visually-hidden"),w.classList.add("visually-hidden"),k.classList.remove("visually-hidden")):(w.classList.remove("visually-hidden"),k.classList.remove("visually-hidden"),k.classList.add("visually-hidden")))})).catch((e=>{console.error(e)})),(0,o.get)((0,o.child)((0,o.ref)((0,o.getDatabase)()),`users/${m}/queueOfMovies/${s}`)).then((e=>{m&&(e.exists()?(x.classList.remove("visually-hidden"),x.classList.add("visually-hidden"),C.classList.remove("visually-hidden")):(x.classList.remove("visually-hidden"),C.classList.remove("visually-hidden"),C.classList.add("visually-hidden")))})).catch((e=>{console.error(e)})),document.querySelector(".modal__close").addEventListener("click",I),document.addEventListener("keyup",I)}function k(){const e=l.create('\n    <div class="modal-body">    \n        <p class="modal-title">Sign In</p>        \n        <form action="" id="signInForm"> \n            <div class="form-field">    \n                <label for="username" class="input-text">Name</label>\n                <div class="input-wrap">            \n                    <input id="username" type="text" name="username" placeholder="Your name">\n                </div>\n            </div>\n            <div class="form-field">\n                <label for="email" class="input-text">Email</label>\n                <div class="input-wrap">\n                    <input id="email" type="email" name="email" placeholder="Your email">\n                </div>\n            </div>\n            <div class="form-field">\n                <label for="password" class="input-text">Password</label>\n                <div class="input-wrap">\n                    <input id="password" type="password" name="password" placeholder="Your password">\n                </div>\n            </div>\n             <div class="form-button">\n            <button id="submitSignInBtn" type="submit">Confirm</button>\n            </div>\n        </form>\n        <button type="button" class="modal-button">\n                <svg class="modal-button-x" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">\n                <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path>\n                </svg>\n        </button>\n    </div>\n',{onShow:e=>{document.querySelector("body").style.overflow="hidden",e.element().querySelector(".modal-button-x").onclick=e.close},onClose:e=>{document.querySelector("body").style.overflow="auto"},closable:!0});e.show();const n=document.querySelector("#signInForm");n.addEventListener("submit",(function(e){e.preventDefault();const i=document.querySelector("#username").value,r=document.querySelector("#email").value,s=document.querySelector("#password").value;(0,a.a5)(p,r,s).then((e=>{const t=e.user;(0,o.set)((0,o.ref)(d,"users/"+t.uid),{email:r,displayName:i,online:!0}),n.reset(),w.innerHTML=`${p.currentUser.email}`,_.classList.add("visually-hidden"),v.classList.add("visually-hidden"),b.classList.remove("visually-hidden"),alert(`User: ${p.currentUser.email} created!`),window.location.reload()})).catch((e=>{e.code,e.message;t(c).Notify.failure("smth wrong!")}))})),document.querySelector("body").addEventListener("keydown",(function t(n){"Escape"!==n.key&&"submit"!==n||(e.close(),gallery.removeEventListener("keydown",t),gallery.removeEventListener("click",k))}))}v.addEventListener("click",k),_.addEventListener("click",(function(){const e=l.create('    \n    <div class="modal-body">    \n        <p class="modal-title">log In</p>        \n        <form action="" id="logInForm">             \n            <div class="form-field">\n                <label for="email" class="input-text">Email</label>\n                <div class="input-wrap">\n                    <input id="email" type="email" name="email" placeholder="Your email">\n                </div>\n            </div>\n            <div class="form-field">\n                <label for="password" class="input-text">Password</label>\n                <div class="input-wrap">\n                    <input id="password" type="password" name="password" placeholder="Your password">\n                </div>\n            </div>\n             <div class="form-button">\n            <button id="submitLogInBtn" type="submit">Confirm</button>\n            </div>\n        </form>\n        <button type="button" class="modal-button">\n                <svg class="modal-button-x" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">\n                <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path>\n                </svg>\n        </button>\n    </div>\n',{onShow:e=>{document.querySelector("body").style.overflow="hidden",e.element().querySelector(".modal-button-x").onclick=e.close},onClose:e=>{document.querySelector("body").style.overflow="auto"},closable:!0});e.show();document.querySelector("#logInForm").addEventListener("submit",(function(t){t.preventDefault();const n=document.querySelector("#email").value,i=document.querySelector("#password").value;(0,a.a6)(p,n,i).then((e=>{const t=e.user,n=new Date;(0,o.update)((0,o.ref)(d,"users/"+t.uid),{last_login:n,online:!0}),w.innerHTML=`${p.currentUser.email}`,_.classList.add("visually-hidden"),v.classList.add("visually-hidden"),b.classList.remove("visually-hidden"),window.location.reload()})).catch((e=>{e.code,e.message,alert("wrong password")})),document.querySelector("body").addEventListener("keydown",(function t(n){"Escape"===n.key&&(e.close(),gallery.removeEventListener("keydown",t),gallery.removeEventListener("click",k))}))}))})),b.addEventListener("click",(function(){(0,o.update)((0,o.ref)(d,"users/"+p.currentUser.uid),{online:!1}),(0,a.y)(p).then((()=>{_.classList.remove("visually-hidden"),v.classList.remove("visually-hidden"),w.innerHTML="",f=null,b.classList.add("visually-hidden"),document.querySelector("#nav-library").classList.add("visually-hidden")})).catch((e=>{})),localStorage.removeItem("queue"),localStorage.removeItem("watched")})),(0,a.v)(p,(e=>{if(e){m=e.uid,f=e.email;const t=(0,o.ref)((0,o.getDatabase)());(0,o.get)((0,o.child)(t,`users/${m}/watchedMovies`)).then((async e=>{e.exists()?(g=await e.val(),localStorage.setItem("watched",JSON.stringify(Object.values(g)))):console.log("No data available")})).catch((e=>{console.error(e)})),(0,o.get)((0,o.child)(t,`users/${m}/queueOfMovies`)).then((async e=>{e.exists()?(y=await e.val(),localStorage.setItem("queue",JSON.stringify(Object.values(y)))):(console.log("No data available"),localStorage.removeItem("queue"))})).catch((e=>{console.error(e)}))}})),window.addEventListener("DOMContentLoaded",(()=>{(0,o.get)((0,o.child)((0,o.ref)((0,o.getDatabase)()),`users/${m}/online`)).then((e=>{f&&(w.innerHTML=`${p.currentUser.email.split("@")[0]}`,_.classList.add("visually-hidden"),v.classList.add("visually-hidden"),b.classList.remove("visually-hidden"),document.querySelector("#nav-library").classList.remove("visually-hidden"))})).catch((e=>{console.error(e)}))}))})),s.register("25RCP",(function(t,n){e(t.exports,"initializeApp",(function(){return s("ix4Jr").initializeApp})),e(t.exports,"registerVersion",(function(){return s("ix4Jr").registerVersion}));s("ix4Jr");
/**
 * @license
...
//# sourceMappingURL=my-library.a7b4f826.js.map
